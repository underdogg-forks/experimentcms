 ...
 * Generated for Laravel 5.3.31 on 2017-05-20.
 *
...
namespace Nwidart\Menus\Facades {
    ...
    class Menu {
        ...
        {
            return \Nwidart\Menus\Menu::make($name, $callback);
        }
        ...
        {
            return \Nwidart\Menus\Menu::create($name, $resolver);
        }
        ...
        public static function has($name)
        {
            return \Nwidart\Menus\Menu::has($name);
        }
        ...
        {
            return \Nwidart\Menus\Menu::instance($name);
        }
        ...
        {
            \Nwidart\Menus\Menu::modify($name, $callback);
        }
        ...
        {
            return \Nwidart\Menus\Menu::get($name, $presenter, $bindings);
        }
        ...
        {
            return \Nwidart\Menus\Menu::render($name, $presenter, $bindings);
        }
        ...
        {
            return \Nwidart\Menus\Menu::style();
        }
        ...
        public static function count()
        {
            return \Nwidart\Menus\Menu::count();
        }
        ...
        {
            return \Nwidart\Menus\Menu::destroy();
        }
...
namespace Modules\Menu\Blade\Facades {
    ...
    class MenuDirective {
        ...
        {
            return \Modules\Menu\Blade\MenuDirective::show($arguments);
        }
...
namespace Modules\Setting\Facades {
    ...
    class Settings {
        ...
        {
            return \Modules\Setting\Support\Settings::get($name, $locale, $default);
        }
        ...
        public static function has($name)
        {
            return \Modules\Setting\Support\Settings::has($name);
        }
        ...
        {
            return \Modules\Setting\Support\Settings::set($key, $value);
        }
...
namespace Modules\Setting\Blade\Facades {
    ...
    class SettingDirective {
        ...
        public static function show($arguments)
        {
            return \Modules\Setting\Blade\SettingDirective::show($arguments);
        }
...
namespace Modules\Tag\Blade\Facades {
    ...
    class TagWidget {
        ...
        public static function show($arguments)
        {
            return \Modules\Tag\Blade\TagWidget::show($arguments);
        }
...
namespace {
    ...
    class Menu extends \Nwidart\Menus\Facades\Menu {}
    
    class MenuDirective extends \Modules\Menu\Blade\Facades\MenuDirective {}
    
    class Setting extends \Modules\Setting\Facades\Settings {}
    
    class SettingDirective extends \Modules\Setting\Blade\Facades\SettingDirective {}
    
    class TagWidget extends \Modules\Tag\Blade\Facades\TagWidget {}
